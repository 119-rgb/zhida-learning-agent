...
public final class ConversationContext {
    ...
    public static List<Message> withMemories(List<Message> messages, List<ConversationRepository.Memory> memories) {
    ...
    public static List<Message> withSummary(List<Message> messages, String summary) {
    ...
    public static List<Message> restore(List<ConversationRepository.Message> history, String question) {
        ...
        for (int i = exchanges.size() - 1; i >= 0; i--) {
            ...
            result.addAll(0, List.of(
                    new UserMessage(pair.get(0).content()),
                    new AssistantMessage(pair.get(1).content())
            ));
            chars += size;
        }
